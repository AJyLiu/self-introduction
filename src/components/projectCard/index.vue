<template>
  <ElRow :span="24" :gutter="25" class="row-list">
    <ElCol
      :xs="24"
      :sm="12"
      :md="8"
      :lg="6"
      :xl="6"
      v-for="(projectData, index) in projectDataList"
      :key="projectData.id"
      class="col-item"
    ...
    >
      <div class="project-card">
        ...
        <svg class="card-svg" fill="none" viewBox="0 0 87 8">
          <path
            :fill="activeIndex === index ? '#ffffff' : '#1C3F39'"
            d="M86.354 4.354a.5.5 0 000-.708L83.172.464a.5.5 0 10-.707.708L85.293 4l-2.829 2.828a.5.5 0 10.708.708l3.182-3.182zM0 4.5h86v-1H0v1z"
          ></path>
        </svg>
      </div>
    </ElCol>
